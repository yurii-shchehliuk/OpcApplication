...
{
    public class PluginConfiguration : QIAWorkerConfig, IAppSettings
    {
        public PluginConfiguration(IConfiguration configuration, string section) : base(configuration, section)
        {
